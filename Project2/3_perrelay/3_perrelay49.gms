...
perRelay(i,j,k)$((ord(j)>1)and (alpha(i,j) > angle/2))..                         f(i,j,k) =e= 0;
...
file sonuc /C:\WSN\3_MODEL%nodec%.txt/;
file energyDis /C:\WSN\3_MODEL%nodec%_ED.txt/;
file lifetime /C:\WSN\3_MODEL%nodec%_LT.txt/;
