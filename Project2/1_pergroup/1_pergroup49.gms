...
perGroup(i,j,k)$((ord(i)>1)and (ord(j)>1)and(ord(k)>1)and(ceil(a(i)/angle) <> ceil(a(j)/angle)))..           f(i,j,k)=e=0;
...
file sonuc /C:\WSN\1_MODEL%nodec%.txt/;
file energyDis /C:\WSN\1_MODEL%nodec%_ED.txt/;
file lifetime /C:\WSN\1_MODEL%nodec%_LT.txt/;
